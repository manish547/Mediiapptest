...
function ResourcesPage() {
  ...
  return (
    <div className="container mx-auto flex flex-col-reverse md:flex-row items-start justify-center md:justify-between gap-8 md:gap-0 px-3 ">
      <div
      ...
      >
        <div className="w-full flex flex-col items-center md:items-stretch">
          <h1 className=" font-bold text-5xl leading-[65px] text-center lg:text-start lg:pl-9  xl:pl-[120px] 2xl:pl-12 text-black">
            Resources
          </h1>
      ...
      <div className="w-full md:w-[30%] h-full mt-16  flex flex-col-reverse md:flex-col gap-6 md:gap-8">
